...
public class CommentPrivateController {
    ...
    public CommentShortDto createComment(
        ...
        log.info("CommentPrivateController POST /users/{}/comments, event: {}, dto: {}",
                userId, eventId,  dto);
        return commentFacade.createComment(userId, eventId, dto);
    }
    ...
    public CommentShortDto updateComment(
        ...
        return commentFacade.updateComment(userId, commentId, dto);
    }
    ...
    public void delete(
        ...
        commentFacade.deleteByUser(userId, commentId);
    }
}
