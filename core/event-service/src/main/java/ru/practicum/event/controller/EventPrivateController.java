...
public class EventPrivateController {
    ...
    public EventFullDto createEvent(
        ...
        return eventFacade.createEvent(userId, newEventDto);
    }
    ...
    public List<EventShortDto> getUserEvents(
        ...
        return eventFacade.getUserEvents(userId, pageable);
    }
    ...
    public EventFullDto getUserEvent(
        ...
        return eventFacade.getUserEvent(userId, eventId);
    }
    ...
    public EventFullDto updateUserEvent(
        ...
        return eventFacade.updateEventByUser(userId, eventId, request);
    }
    ...
    public List<ParticipationRequestDto> getEventRequests(
        ...
        return eventFacade.getEventRequests(userId, eventId);
    }
    ...
    public EventRequestStatusUpdateResult updateEventRequestsStatus(
        ...
        return eventFacade.updateEventRequestsStatus(userId, eventId, request);
    }
}
